...
@Autonomous (name = "Right Medium Pole Then Park", group = "Deprecated")
public class MediumConeParkRight extends LinearOpMode {
    ...
    public void autonomous()
    {
        ...
        strafe(1, FORWARD+3, 2270);//run forward 2 tiles
        liftToPositionAndFlip(MEDIUM+1000, ARM_FLIPPED, ROTATE_DOWNSIDE);//flip over arm and raise lifts
        strafe(1, LEFT, 640);//strafe left to pole
        strafe(0.5, FORWARD, 400);//go forward a bit
        sleep(1000);
        ...
        sleep(500);
        liftToPositionAndFlip(0 , 300, ROTATE_UPSIDE);//put arm and lifts back
        strafe(0.5, BACKWARD, 400);//go backwards a bit
        sleep(200);
        switch(positionToGo)
        {
            case 1:
            ...
            case 2:
                //run right a bit
                strafe(1, RIGHT, 640);//strafe right to center
                break;
            case 3:
                //run right
                strafe(1, RIGHT, 640);//strafe right to center
                sleep(200);
                strafe(1,BACKWARD,1100);
                sleep(200);
                strafe(1,RIGHT,1575);
                break;
        }
