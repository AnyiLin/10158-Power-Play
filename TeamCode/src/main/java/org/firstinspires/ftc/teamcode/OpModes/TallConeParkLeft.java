...
@Autonomous (name = "Left Tall Pole Then Park", group = "Deprecated")
public class TallConeParkLeft extends LinearOpMode {
    ...
    public void autonomous()
    {
        ...
        sleep(200);
        turn(0.7,"left",2520);//turn left to tall pole backwards
        liftToPositionAndFlip(TALL, ARM_FLIPPED, ROTATE_DOWNSIDE);//flip over arm and raise lifts
        strafe(0.5, BACKWARD, 350);//moves towards pole
        sleep(1200);
        ...
        strafe(0.5, FORWARD, 350);//go back a bit
        turn(0.7,"right",2540);//turn right to center `
        strafe(0.7, BACKWARD, 1600); //run backwards to position
